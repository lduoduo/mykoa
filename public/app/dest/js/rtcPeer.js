...
fn.init = function (address, stream) {
    if (!address) return
    this.stream = stream;

    this.duoduo_signal.init(address);
    if (this.inited) {
        return this.updateStream()
    }
    this.duoduo_signal.on('connected', this.setup.bind(this))
...
fn.setup = function () {
    ...
    this.listeners['ready'] && this.listeners['ready'](this.duoduo_signal.ws.url)
}
